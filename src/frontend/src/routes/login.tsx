...
function RouteComponent() {
  ...
  return (
    <AuthLayout>
      <AuthCard>
        <h1 className="m-0 text-xl font-semibold text-gray-100 mb-6">Log in to your account</h1>
        ...
        <form onSubmit={handleEmailLogin} className="grid gap-4 mb-5">
          ...
          <div className="grid gap-1.5">
            <div className="flex justify-between items-baseline">
              ...
              <Link to="/forgot-password" className="text-xs text-indigo-400 hover:text-indigo-300 no-underline">
                Forgot password?
              </Link>
            </div>
            <input
        ...
        <div className="grid gap-2">
          <button
            ...
            className="w-full py-2.5 px-4 text-sm font-medium text-gray-200 bg-gray-800/60 border border-white/10 rounded-md hover:bg-gray-700/60 transition-colors cursor-pointer flex items-center justify-center gap-2"
          >
