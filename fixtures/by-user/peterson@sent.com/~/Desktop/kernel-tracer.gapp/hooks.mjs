...
function I(t, _, u) {
  ...
  if (
    ...
    o.__f = !0
    var h = o.shouldComponentUpdate,
      E = o.componentWillUpdate
...
function R(t, _) {
  var u = l(c++, 4)
  !r.__s && y(u.__H, _) && ((u.__ = t), (u.u = _), o.__h.push(u))
}
function z(t) {
  return (
    (v = 5),
...
function G(t) {
  var _ = o.context[t.__c],
    u = l(c++, 9)
  return (
    (u.c = t),
    _ ? (u.__ == null && ((u.__ = !0), _.sub(o)), _.props.value) : t.__
  )
}
function J(t, _) {
  r.useDebugValue && r.useDebugValue(_ ? _(t) : t)
}
function K(t) {
  var _ = l(c++, 10),
    u = B()
  return (
    (_.__ = t),
    o.componentDidCatch ||
      (o.componentDidCatch = function (n, i) {
        ;(_.__ && _.__(n, i), u[1](n))
      }),
    [
      u[0],
...
function O() {
  var t = l(c++, 11)
  if (!t.__) {
    for (var _ = o.__v; _ !== null && !_.__m && _.__ !== null; ) _ = _.__
  ...
  (r.__r = function (t) {
    ...
    ;(_ &&
      (d === o
        ...
        : (_.__h.forEach(p), _.__h.forEach(H), (_.__h = []), (c = 0))),
      (d = o))
  }),
  (r.diffed = function (t) {
    A && A(t)
